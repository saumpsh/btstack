...
// clang-format off
// example/gatt_streamer_server.h generated from example/gatt_streamer_server.gatt for BTstack
// it needs to be regenerated when the .gatt file is updated. 

// To generate example/gatt_streamer_server.h:
// tool/compile_gatt.py example/gatt_streamer_server.gatt example/gatt_streamer_server.h
